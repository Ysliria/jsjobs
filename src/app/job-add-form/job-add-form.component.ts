...
export class JobAddFormComponent implements OnInit {
  ...
  contractTypes = [
    ...
    {id: 2, name: 'intérimm', value: 'temp'},
    {id: 3, name: 'contrat à durée déterminé (CDD)', value: 'fixed-term'},
    {id: 4, name: 'contrat à durée indéterminé (CDI)', value: 'permanent'},
